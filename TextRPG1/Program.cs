...
namespace TextRPG
{
    ...
    class Program
    {
        ...
        //   Program.AddAndPrint(6, 14);
        //   Program.AddAndPrint(5, 21);
        //   Program.AddAndPrint(22, 8);
        //   Program.AddAndPrint(1, 5);
        //}
        enum ClassType
        {
            None = 0,
